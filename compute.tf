...
resource "oci_core_instance" "postgresql_master" {
  ...
  display_name        = "${var.postgresql_display_name}_Master"
  ...
  source_details {
    source_type = "image"
    source_id   = coalesce(var.image_ocid, data.oci_core_images.InstanceImageOCID_postgresql_instance_shape.images[0].id)
...
resource "oci_core_boot_volume_backup" "postgresql_master_boot_volume_backup" {
  ...
  display_name        = "${var.postgresql_display_name}_Master_Boot_Volume_Backup_FULL"
...
resource "oci_core_instance" "postgresql_hotstandby1" {
  ...
  compartment_id      = var.compartment_ocid
  display_name        = "${var.postgresql_display_name}_HotStandby1"
...
resource "oci_core_boot_volume_backup" "postgresql_hotstandby1_boot_volume_backup" {
  ...
  display_name        = "${var.postgresql_display_name}_Hotstandby1_Boot_Volume_Backup_FULL"
...
resource "oci_core_instance" "postgresql_hotstandby2" {
  ...
  compartment_id      = var.compartment_ocid
  display_name        = "${var.postgresql_display_name}_HotStandby2"
...
resource "oci_core_boot_volume_backup" "postgresql_hotstandby2_boot_volume_backup" {
  ...
  display_name        = "${var.postgresql_display_name}_Hotstandby2_Boot_Volume_Backup_FULL"
